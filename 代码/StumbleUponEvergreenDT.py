...
# 数据集的第4个字段是网页分类，分类特征字段必须转换为数值字段才能够被分类算法使用
...
# trainEvaluateModel(trainData, validationData, "entropy", 10, 5)
...
#               maxBinsList=[10])
# 从图中可以看到，maxDepth=5，AUC最高，maxDepth越大，所需时间越多，所以10可能是不错的选择
...
# 从图中可以看到，maxBins=5，AUC最高，maxBins越大，所需时间越多，所以10可能是不错的选择
